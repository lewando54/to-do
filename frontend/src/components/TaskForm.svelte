...
<form transition:fly={{ duration: 400, y: -200, opacity: 0, easing: quintOut}}>
    <div class="modal-input">
        ...
        <input id="task-title" type="text" placeholder="e.g. Take the dog for a walk" />
    </div>
    <div class="modal-input">
        <label for="task-title">Description</label>
        <textarea placeholder="e.g. Walk minimum 3km on the standard route. Remember to bring some water!!!"></textarea>
    </div>
